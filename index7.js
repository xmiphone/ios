...
function medkit() {
h5gg.clearResults();
h5gg.searchNumber('16802165159722883375', 'I64', '0x100000000', '0x200000000');
h5gg.editAll('16375949441539643695', 'I64');
vant.showNotify({
    type: 'success',
    message: '𝐅𝐚𝐬𝐭 𝐌𝐞𝐤𝐢𝐭'
});
...
function ammo() {
h5gg.clearResults();
h5gg.searchNumber('16226468490608902324', 'I64', '0x100000000', '0x200000000');
h5gg.editAll('16226468490572202164', 'I64');
vant.showNotify({
    type: 'success',
    message: '𝐔𝐧𝐥𝐢𝐦𝐢𝐭𝐞𝐝 𝐀𝐦𝐦𝐨'
});
}
