...
function medkit() {
h5gg.clearResults();
h5gg.searchNumber('16802165159722883375', 'F64', '0x100000000', '0x200000000');
h5gg.editAll('16375949441539643695', 'F64');
vant.showNotify({
    type: 'success',
    message: '𝐅𝐚𝐬𝐭 𝐌𝐞𝐤𝐢𝐭'
});
...
function ammo() {
    ...
    h5gg.clearResults(); h5gg.searchNumber(searchValue, type, '0x100000000', '0x160000000'); var results = h5gg.getResults(h5gg.getResultsCount()); for (var i = 0; i < results.length; i++) {
    h5gg.setValue(results[i].address, replaceValue.toString(), type)}}
    searchAndReplace(16226468490608902324, 16226468490572202164, 'I32')
